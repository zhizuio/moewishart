...
datSimN200 <- rbind(datSimN200, data.frame(n = "n=200", method = "Bayes", estimator = "pi-norm1", error = pi.error[,1] )) # posterior mean
datSimN200 <- rbind(datSimN200, data.frame(n = "n=200", method = "EM", estimator = "pi-norm1", error = pi.error[,3] ))
datSimN200 <- rbind(datSimN200, data.frame(n = "n=200", method = "Bayes.X", estimator = "pi-norm1", error = pi.error2[,1] ))
datSimN200 <- rbind(datSimN200, data.frame(n = "n=200", method = "EM.X", estimator = "pi-norm1", error = pi.error2[,3] ))
datSimN200 <- rbind(datSimN200, data.frame(n = "n=200", method = "Bayes", estimator = "nu-norm1", error = nu.error[,1] ))
datSimN200 <- rbind(datSimN200, data.frame(n = "n=200", method = "EM", estimator = "nu-norm1", error = nu.error[,3] ))
datSimN200 <- rbind(datSimN200, data.frame(n = "n=200", method = "Bayes.X", estimator = "nu-norm1", error = nu.error2[,1] ))
datSimN200 <- rbind(datSimN200, data.frame(n = "n=200", method = "EM.X", estimator = "nu-norm1", error = nu.error2[,3] ))
datSimN200 <- rbind(datSimN200, data.frame(n = "n=200", method = "Bayes", estimator = "Sigma-norm1", error = Sigma.error[,1] ))
datSimN200 <- rbind(datSimN200, data.frame(n = "n=200", method = "EM", estimator = "Sigma-norm1", error = Sigma.error[,3] ))
datSimN200 <- rbind(datSimN200, data.frame(n = "n=200", method = "Bayes.X", estimator = "Sigma-norm1", error = Sigma.error2[,1] ))
datSimN200 <- rbind(datSimN200, data.frame(n = "n=200", method = "EM.X", estimator = "Sigma-norm1", error = Sigma.error2[,3] ))
datSimN200 <- rbind(datSimN200, data.frame(n = "n=200", method = "Bayes", estimator = "Sigma-normF", error = Sigma.error[,2] ))
datSimN200 <- rbind(datSimN200, data.frame(n = "n=200", method = "EM", estimator = "Sigma-normF", error = Sigma.error[,4] ))
datSimN200 <- rbind(datSimN200, data.frame(n = "n=200", method = "Bayes.X", estimator = "Sigma-normF", error = Sigma.error2[,2] ))
