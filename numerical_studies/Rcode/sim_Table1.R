##========================================================================================
## This file contains code to produce Table 1
## 
## Input: Data files from R code 
##        'simN200_p2.R', 'simN500_p2.R', 'simN1000_p2.R'
##        'simN200_p8.R', 'simN500_p8.R', 'simN1000_p8.R'
## Output: Table 1
##========================================================================================

rm(list = ls())

# specify folder directory including the results from R code 'simN200_p2.R', 'simN500_p2.R' etc.
