...
datSimN200 <- rbind(datSimN200, data.frame(n = "n=200", method = "EM.X", estimator = "Beta-norm1", error = beta.error2[,3] ))
datSimN200 <- rbind(datSimN200, data.frame(n = "n=200", method = "EM.X", estimator = "Beta-normF", error = beta.error2[,4] ))
